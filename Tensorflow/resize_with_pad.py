# -*- coding: utf-8 -*-
"""
Created on Thu Jun 25 18:15:07 2020
...
# To avoid above issue - use tf.image.resize_with_pad()
...
resized_img = tf.image.resize_with_pad(exp_img,100,100,method='bilinear',antialias=False)
